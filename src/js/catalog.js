...
async function initCatalog() {
  ...
  if (filtersBtn && filtersPanel) {
    filtersBtn.addEventListener('mouseenter', showFiltersPanel);
    filtersPanel.addEventListener('mouseleave', hideFiltersPanelOnBlur);
    filtersBtn.addEventListener('mouseleave', hideFiltersPanelOnBlur);
  }
  
  document.getElementById('hide-filters')?.addEventListener('click', hideFiltersPanel);
  document.getElementById('clear-filters')?.addEventListener('click', resetFilters);
  
  // Open select dropdown on hover
